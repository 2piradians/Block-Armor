...
import twopiradians.blockArmor.client.render.model.IAnimationChanger;
import twopiradians.blockArmor.client.render.model.IExtendedModelPart;
import twopiradians.blockArmor.client.render.model.IModel;
import twopiradians.blockArmor.client.render.model.IModelCustom;
import twopiradians.blockArmor.client.render.model.IPartTexturer;
import twopiradians.blockArmor.client.render.model.IRetexturableModel;
import twopiradians.blockArmor.client.render.model.Vector4;
import twopiradians.blockArmor.client.render.model.Vertex;
import twopiradians.blockArmor.client.render.x3d.X3dXML.Appearance;
import twopiradians.blockArmor.client.render.x3d.X3dXML.IndexedTriangleSet;
import twopiradians.blockArmor.client.render.x3d.X3dXML.Transform;
...
public class X3dModel implements IModelCustom, IModel, IRetexturableModel
{
    ...
    HashMap<String, IExtendedModelPart> makeObjects(X3dXML xml) throws Exception
    {
        ...
        for (Transform t : allTransforms)
        {
            ...
            Vector3f translation = new Vector3f(Float.parseFloat(offset[0]), Float.parseFloat(offset[1]),
