...
public class X3dXML
{
    ...
    public static class IndexedTriangleSet
    {
        ...
        public static class TextureCoordinate
        {
            ...
            public twopiradians.blockArmor.client.model.x3d.TextureCoordinate[] getTexture()
            {
                ArrayList<twopiradians.blockArmor.client.model.x3d.TextureCoordinate> ret = new ArrayList<twopiradians.blockArmor.client.model.x3d.TextureCoordinate>();
                ...
                {
                	twopiradians.blockArmor.client.model.x3d.TextureCoordinate toAdd = new twopiradians.blockArmor.client.model.x3d.TextureCoordinate(
                            Float.parseFloat(points[i]), 1 - Float.parseFloat(points[i + 1]));
                    ret.add(toAdd);
                }
                return ret.toArray(new twopiradians.blockArmor.client.model.x3d.TextureCoordinate[ret.size()]);
            }
        }
