...
public class BlockUtils {
	...
	private static final Field MATERIAL_FIELD = ObfuscationReflectionHelper.findField(BlockBehaviour.Properties.class, "material");
	/**Block properties -> isSolid*/
	private static final Field IS_SOLID_FIELD = ObfuscationReflectionHelper.findField(BlockBehaviour.Properties.class, "canOcclude");
	/**Block properties -> requiresTool*/
	private static final Field REQUIRES_TOOL_FIELD = ObfuscationReflectionHelper.findField(BlockBehaviour.Properties.class, "requiresCorrectToolForDrops");
