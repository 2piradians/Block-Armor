...
public class ItemBlockArmor extends ItemArmor
{
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int slot, boolean isSelected) {	
		...
		if ((stack == null || stack.stackSize == 0) || (!set.isEnabled() && !world.isRemote & entity instanceof EntityPlayer) || 
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack stack) {		
		//delete dev spawned items if not worn by dev and delete disabled items (except missingTexture items in SMP)
		if ((stack == null || stack.stackSize == 0) || (!set.isEnabled() && !world.isRemote) || 
