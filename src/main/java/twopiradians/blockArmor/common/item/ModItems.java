        ...
        public static void registerItems(final RegistryEvent.Register<Item> event) {
            ...
            for (ArmorSet set : ArmorSet.allSets) {
                if (!Config.disabledSets.contains(set)) {
                    ...
                    recipes.add(new ShapedRecipes("Block Armor", 3, 2, helmetRecipe, new ItemStack(set.helmet)).setRegistryName(set.helmet.getRegistryName()));
                    recipes.add(new ShapedRecipes("Block Armor", 3, 3, armorRecipe, new ItemStack(set.chestplate)).setRegistryName(set.chestplate.getRegistryName()));
                    recipes.add(new ShapedRecipes("Block Armor", 3, 3, legsRecipe, new ItemStack(set.leggings)).setRegistryName(set.leggings.getRegistryName()));
                    recipes.add(new ShapedRecipes("Block Armor", 3, 2, bootsRecipe, new ItemStack(set.boots)).setRegistryName(set.boots.getRegistryName()));
                    set.recipes = recipes;
                }
            }
