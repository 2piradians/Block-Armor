...
public class ModItems
{
	...
	public static void postInit() {
		...
		for (ArmorSet set : ArmorSet.allSets) 
			if (!ArmorSet.autoGeneratedSets.containsKey(set) || ArmorSet.autoGeneratedSets.get(set) == true) { //if enabled in config
				String registryName = ArmorSet.getItemStackRegistryName(set.stack);
				set.helmet = (ItemBlockArmor) registerItem(new ItemBlockArmor(set.material, 0, EntityEquipmentSlot.HEAD), registryName+"_helmet", true, set.isFromModdedBlock);
				set.chestplate = (ItemBlockArmor) registerItem(new ItemBlockArmor(set.material, 0, EntityEquipmentSlot.CHEST), registryName+"_chestplate", true, set.isFromModdedBlock);
				set.leggings = (ItemBlockArmor) registerItem(new ItemBlockArmor(set.material, 0,EntityEquipmentSlot.LEGS), registryName+"_leggings", true, set.isFromModdedBlock);
				set.boots = (ItemBlockArmor) registerItem(new ItemBlockArmor(set.material, 0, EntityEquipmentSlot.FEET), registryName+"_boots", true, set.isFromModdedBlock);
