...
public class Config 
{
	...
	public static final String SET_EFFECTS_CATEGORY = "config.armorSetEffects";//"Armor Set Effects";
	...
	public static final String AUTO_GEN_SETS_CATEGORY = "config.autoGeneratedArmorSets";//"Auto-Generated Armor Sets";
	/**0 = enabled, 1 = disabled, 2 = custom*/
